...
spec = describe "interpretScript" $ do
        ...
        it "should turn the robot left" $
          interpretScript (Cond (CmpLogicInt $ Sup LaserDistance 5) (Token TurnLeft) (Token MoveForward)) "UniqRobot" gameStateAgainstObstacle `shouldBe` TurnLeft 
